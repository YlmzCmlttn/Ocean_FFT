...
public class OceanEditor : Editor {
    ...
    SerializedProperty oceanShader;
    ...
    void OnEnable() {
        ...
        planeLength = serializedObject.FindProperty("planeSize");
        quadRes = serializedObject.FindProperty("resolution");
